...
def parse_circles_arguments():
    ...
    parser.add_argument('-d', '--distribution', type=str, choices=['uniform', 'lognormal'], default='uniform', help='Distribution of circle length (uniform or lognormal)')
    ...
    parser.add_argument('-m', '--mean', type=int, default=1000, help='Mean length of eccDNA')
    parser.add_argument('-sd', '--sd', type=int, default=100, help='Stand deviation length of eccDNA')
