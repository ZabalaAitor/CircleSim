...
def parse_coordinates_arguments(parser):
    ...
    parser.add_argument('-L', '--length_max', type=int, default=10000, help='Maximum length of eccDNA [default = 2000]')
...
def parse_reads_arguments(parser):
    ...
    parser.add_argument('--mutation', action='store_true', help="Enable mutation simulation.")
    parser.add_argument('--save_unmutated', action='store_true', help="Save unmutated reads.")
    parser.add_argument('--mutation_rate', type=float, default=0.01, help="Mutation rate for simulated reads. Default is 0.01.")
    parser.add_argument('--error_rate', type=float, default=0.001, help="Sequencing error rate for simulated reads. Default is 0.001")
    parser.add_argument('-g', '--genome_fasta', type=str, help='Path to the genome FASTA file')
