...
class SimulateEccDNA:
    ...
    def __init__(self, total_eccDNA, length_min, length_max, genome_fasta, output_bed):
        self.total_eccDNA = total_eccDNA
    ...
    def select_chromosomes(self):
        ...
        # Filter chromosomes
        with Fasta(genome_fasta) as fasta:
...
if __name__ == "__main__":
    ...
    eccdna_instance = SimulateEccDNA(args.total_eccDNA, args.length_min, args.length_max, args.genome_fasta, args.output_bed)
    eccdna_instance.run()
